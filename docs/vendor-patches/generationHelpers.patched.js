...
function serializeBytes(data) {
    // PATCH: accept any TypedArray view (e.g. native Uint8Array produced by
    // the browser Uint8Array patch) — plain `instanceof Buffer` fails when a
    // second Buffer implementation exists in the bundle.
